...
final class NCBrandOptions: @unchecked Sendable {
    ...
    var brand: String = "TCM Storage"
    var brandUserAgent: String = "TCM-Storage"
    var textCopyrightNextcloudiOS: String = "TCM Storage for iOS %@ © 2026"
    var textCopyrightNextcloudServer: String = "TCM Storage Server %@"
    var loginBaseUrl: String = "https://thecloudmarket.thecloud.market"
    var pushNotificationServerProxy: String = ""
    var linkLoginHost: String = "https://thecloud.market"
